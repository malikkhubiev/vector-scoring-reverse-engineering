...
Они подчёркивают расхождение между интуитивной моделью («нормализованный косинус») и реальной реализацией («порогозависимое аффинное преобразование»).
...
Кандидаты разбиваются на две кластера, каждая из которых согласована со «своим» \( T \). Это свидетельствует о наличии двух пороговых режимов в продакшене.
...
Если один и тот же косинус \( x \) оценивается при \( T_1 \) и \( T_2 \), то:
